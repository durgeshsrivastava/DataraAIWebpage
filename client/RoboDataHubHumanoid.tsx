...
.d-subbar { position: sticky; top: var(--nav-h); z-index: 90; height: var(--sub-h); background: var(--surface); border-bottom: 1px solid var(--border); display:flex; align-items:center; padding:0 28px; }
...
.d-btn-imp { display:flex; align-items:center; gap:5px; font-size:12px; font-weight:700; color:var(--green); background:var(--gglow); border:1px solid rgba(52,211,153,0.22); border-radius:8px; padding:4px 13px; cursor:pointer; font-family:inherit; transition:background .15s; }
.d-btn-imp:hover { background:rgba(52,211,153,0.14); }

.d-hero-wrap { position:relative; overflow:hidden; }
.d-hero-wrap::before { content:''; position:absolute; inset:0; background: radial-gradient(ellipse 60% 50% at 72% 50%, rgba(52,211,153,0.07) 0%, transparent 70%), radial-gradient(ellipse 40% 60% at 20% 80%, rgba(5,150,105,0.05) 0%, transparent 65%); pointer-events:none; }
...
.d-hero-tag { display:inline-flex; align-items:center; gap:7px; background:rgba(52,211,153,0.07); border:1px solid rgba(52,211,153,0.22); border-radius:20px; padding:5px 14px; margin-bottom:20px; }
...
.d-hero-img { position:relative; height:390px; border-radius:20px; overflow:hidden; border:1px solid var(--border2); box-shadow:0 32px 80px rgba(0,0,0,.7), 0 0 0 1px rgba(52,211,153,.04); }
...
.d-hero-img-ov { position:absolute; inset:0; background:linear-gradient(160deg,rgba(0,0,0,.5) 0%,transparent 50%,rgba(52,211,153,.06) 100%); }
...
.d-sidebar { width:220px; flex-shrink:0; background:var(--surface); border:1px solid var(--border); border-radius:16px; padding:18px 12px; display:flex; flex-direction:column; position:sticky; top:calc(var(--nav-h) + var(--sub-h) + 16px); max-height:calc(100vh - var(--nav-h) - var(--sub-h) - 40px); overflow-y:auto; align-self:flex-start; }
...
.d-sidebar-item.active { background:rgba(52,211,153,0.07); border-color:rgba(52,211,153,0.18); }
...
.d-sidebar-access button:hover { box-shadow:0 0 20px rgba(52,211,153,0.4); transform:translateY(-1px); }
.d-filter-badge { margin-left:auto; font-size:10px; font-weight:700; background:rgba(52,211,153,0.12); color:var(--green); border-radius:20px; padding:1px 7px; }
...
.d-sec-line { flex:1; height:1px; background:linear-gradient(90deg,rgba(52,211,153,0.15),transparent); }
...
.d-card { background:var(--card); border:1px solid var(--border); border-radius:16px; overflow:hidden; display:flex; flex-direction:column; transition:border-color .25s, transform .25s, box-shadow .25s; cursor:pointer; position:relative; flex: 0 0 calc(33.333% - 11px); }
.d-card::before { content:''; position:absolute; top:0; left:0; right:0; height:2px; background:linear-gradient(90deg,var(--green),transparent); opacity:0; transition:opacity .25s; }
.d-card:hover::before { opacity:1; }
.d-card:hover { border-color:rgba(52,211,153,.28); transform:translateY(-5px); box-shadow:0 24px 64px rgba(0,0,0,.6), 0 0 0 1px rgba(52,211,153,.07), 0 0 40px rgba(52,211,153,.04); }
...
.d-cta { background:linear-gradient(128deg,rgba(52,211,153,.08) 0%,rgba(52,211,153,.02) 45%,transparent 70%); border:1px solid rgba(52,211,153,.16); border-radius:20px; padding:52px 56px; display:flex; align-items:center; justify-content:space-between; gap:40px; position:relative; overflow:hidden; }
.d-cta::after { content:''; position:absolute; right:-60px; top:-80px; width:300px; height:300px; background:radial-gradient(circle,rgba(52,211,153,.06),transparent 70%); pointer-events:none; }
...
.d-btn-primary:hover { box-shadow:0 0 28px rgba(52,211,153,.45); transform:translateY(-2px); }
...
const catCounts: Record<string, number> = { all: 9, kitchen: 3, cleaning: 3, household: 3 };
...
export default function RoboDataHubHumanoid() {
  const [activeFilter, setActiveFilter] = useState<string>('all');

  const isVisible = (cat: string) => activeFilter === 'all' || activeFilter === cat;
  const visibleCount = catCounts[activeFilter] ?? 9;
    ...
    <>
      ...
      <div id="optD">
        ...
        <div className="d-subbar">
          ...
          <div className="d-sbr">
            <span className="d-items-l">Showing: <strong>{visibleCount}</strong> datasets</span>
        ...
        <div className="d-body">
          ...
          <div className="d-sidebar">
            <div className="d-sidebar-section">
              ...
              <button className={`d-sidebar-item${activeFilter === 'all' ? ' active' : ''}`} onClick={() => setActiveFilter('all')}>
                <div className="d-sidebar-dot" style={{background:'#34d399'}}></div>
                <span className="d-sidebar-text">All Tasks</span>
              </button>
              <button className={`d-sidebar-item${activeFilter === 'kitchen' ? ' active' : ''}`} onClick={() => setActiveFilter('kitchen')}>
                <div className="d-sidebar-dot" style={{background:'#6ee7b7'}}></div>
                <span className="d-sidebar-text">Kitchen Tasks</span>
              </button>
              <button className={`d-sidebar-item${activeFilter === 'cleaning' ? ' active' : ''}`} onClick={() => setActiveFilter('cleaning')}>
                <div className="d-sidebar-dot" style={{background:'#34d399'}}></div>
                <span className="d-sidebar-text">Cleaning &amp; Hygiene</span>
              </button>
              <button className={`d-sidebar-item${activeFilter === 'household' ? ' active' : ''}`} onClick={() => setActiveFilter('household')}>
                <div className="d-sidebar-dot" style={{background:'#059669'}}></div>
          ...
          <div className="d-main">
            ...
            {/* Kitchen Tasks */}
            <div id="d-kitchen" style={{marginBottom:'40px'}}>
              ...
              <div className="d-ds-grid">
                ...
                <div className={`d-card${!isVisible('kitchen') ? ' d-hidden' : ''}`}>
                  ...
                  <div className="d-card-foot"><span className="d-card-path">humanoid/kitchen/dishwashing</span><button className="d-btn-open">Open folder <ArrowIcon/></button></div>
                </div>
                ...
                <div className={`d-card${!isVisible('kitchen') ? ' d-hidden' : ''}`}>
                  ...
                  <div className="d-card-foot"><span className="d-card-path">humanoid/kitchen/foodPrep</span><button className="d-btn-open">Open folder <ArrowIcon/></button></div>
                </div>
                ...
                <div className={`d-card${!isVisible('kitchen') ? ' d-hidden' : ''}`}>
                  ...
                  <div className="d-card-foot"><span className="d-card-path">humanoid/kitchen/appliance</span><button className="d-btn-open">Open folder <ArrowIcon/></button></div>
                </div>
            ...
            {/* Cleaning & Hygiene */}
            <div id="d-cleaning" style={{marginBottom:'40px'}}>
              <div className="d-sec-head">
                <div className="d-sec-dot"></div>
              ...
              <div className="d-ds-grid">
                ...
                <div className={`d-card${!isVisible('cleaning') ? ' d-hidden' : ''}`}>
                  ...
                  <div className="d-tags"><div className="d-tag">EXO-Centric</div><div className="d-tag">Hand Pose</div><div className="d-tag">Task Labels</div></div>
                  <div className="d-card-foot"><span className="d-card-path">humanoid/cleaning/surfaceWipe</span><button className="d-btn-open">Open folder <ArrowIcon/></button></div>
                </div>
                ...
                <div className={`d-card${!isVisible('cleaning') ? ' d-hidden' : ''}`}>
                  ...
                  <div className="d-card-foot"><span className="d-card-path">humanoid/cleaning/floorMop</span><button className="d-btn-open">Open folder <ArrowIcon/></button></div>
                </div>
                ...
                <div className={`d-card${!isVisible('cleaning') ? ' d-hidden' : ''}`}>
                  ...
                  <div className="d-card-foot"><span className="d-card-path">humanoid/cleaning/bathroom</span><button className="d-btn-open">Open folder <ArrowIcon/></button></div>
                </div>
            ...
            {/* Household Ops */}
            <div id="d-household" style={{marginBottom:'40px'}}>
              <div className="d-sec-head">
                <div className="d-sec-dot"></div>
              ...
              <div className="d-ds-grid">
                ...
                <div className={`d-card${!isVisible('household') ? ' d-hidden' : ''}`}>
                  ...
                  <div className="d-tags"><div className="d-tag">EGO-Centric</div><div className="d-tag">Hand Pose</div><div className="d-tag">Edge Cases</div></div>
                  <div className="d-card-foot"><span className="d-card-path">humanoid/household/trashSort</span><button className="d-btn-open">Open folder <ArrowIcon/></button></div>
                </div>
                ...
                <div className={`d-card${!isVisible('household') ? ' d-hidden' : ''}`}>
                  ...
                  <div className="d-card-foot"><span className="d-card-path">humanoid/household/laundry</span><button className="d-btn-open">Open folder <ArrowIcon/></button></div>
                </div>
                ...
                <div className={`d-card${!isVisible('household') ? ' d-hidden' : ''}`}>
                  ...
                  <div className="d-tags"><div className="d-tag">EXO-Centric</div><div className="d-tag">Task Labels</div></div>
                  <div className="d-card-foot"><span className="d-card-path">humanoid/household/objOrg</span><button className="d-btn-open">Open folder <ArrowIcon/></button></div>
                </div>
