...
.d-btn-imp { display:flex; align-items:center; gap:5px; font-size:12px; font-weight:700; color:var(--green); background:var(--gglow); border:1px solid rgba(251,146,60,0.22); border-radius:8px; padding:4px 13px; cursor:pointer; font-family:inherit; transition:background .15s; }
.d-btn-imp:hover { background:rgba(251,146,60,0.14); }
...
.d-hero-wrap::before {
  ...
  background:
    radial-gradient(ellipse 60% 50% at 72% 50%, rgba(251,146,60,0.07) 0%, transparent 70%),
    radial-gradient(ellipse 40% 60% at 20% 80%, rgba(234,88,12,0.05) 0%, transparent 65%);
  pointer-events:none;
}
...
.d-hero-tag { display:inline-flex; align-items:center; gap:7px; background:rgba(251,146,60,0.07); border:1px solid rgba(251,146,60,0.22); border-radius:20px; padding:5px 14px; margin-bottom:20px; }
...
.d-hero-img { position:relative; height:390px; border-radius:20px; overflow:hidden; border:1px solid var(--border2); box-shadow:0 32px 80px rgba(0,0,0,.7), 0 0 0 1px rgba(251,146,60,.04); }
...
.d-hero-img-ov { position:absolute; inset:0; background:linear-gradient(160deg,rgba(0,0,0,.5) 0%,transparent 50%,rgba(251,146,60,.06) 100%); }
...
.d-sidebar-item.active { background:rgba(251,146,60,0.07); border-color:rgba(251,146,60,0.18); }
...
.d-sidebar-access button:hover { box-shadow:0 0 20px rgba(251,146,60,0.4); transform:translateY(-1px); }
.d-filter-badge { margin-left:auto; font-size:10px; font-weight:700; background:rgba(251,146,60,0.12); color:var(--green); border-radius:20px; padding:1px 7px; }
...
.d-sec-line { flex:1; height:1px; background:linear-gradient(90deg,rgba(251,146,60,0.15),transparent); }
...
.d-card:hover { border-color:rgba(251,146,60,.28); transform:translateY(-5px); box-shadow:0 24px 64px rgba(0,0,0,.6), 0 0 0 1px rgba(251,146,60,.07), 0 0 40px rgba(251,146,60,.04); }
...
.d-cta {
  background:linear-gradient(128deg,rgba(251,146,60,.08) 0%,rgba(251,146,60,.02) 45%,transparent 70%);
  border:1px solid rgba(251,146,60,.16); border-radius:20px;
  padding:52px 56px; display:flex; align-items:center; justify-content:space-between; gap:40px;
  position:relative; overflow:hidden;
}
.d-cta::after { content:''; position:absolute; right:-60px; top:-80px; width:300px; height:300px; background:radial-gradient(circle,rgba(251,146,60,.06),transparent 70%); pointer-events:none; }
...
.d-btn-primary:hover { box-shadow:0 0 28px rgba(251,146,60,.45); transform:translateY(-2px); }
...
const RoboDataHubWarehouse: React.FC = () => {
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div id="optD">
        ...
        {/* Nav */}
        <div style={{ position: 'sticky', top: 0, zIndex: 100, background: 'rgba(5,9,7,0.99)', borderBottom: '1px solid rgba(251,146,60,0.08)', display: 'flex', alignItems: 'stretch', height: '88px', backdropFilter: 'blur(12px)' }}>
          <a
            href="homepage.html"
            ...
            onMouseOver={e => (e.currentTarget.style.background = 'rgba(251,146,60,0.04)')}
            onMouseOut={e => (e.currentTarget.style.background = 'transparent')}
          >
            <span style={{ fontSize: '18px', fontWeight: 800, letterSpacing: '.04em', color: '#fb923c' }}>DataraAI</span>
        ...
        <div className="d-body">
          ...
          <div className="d-sidebar">
            <div className="d-sidebar-section">
              ...
              <button className="d-sidebar-item d-cat-filter" data-dcat="pick">
                <div className="d-sidebar-dot" style={{ background: '#fdba74' }}></div>
                <span className="d-sidebar-text">Pick &amp; Place</span>
              </button>
              <button className="d-sidebar-item d-cat-filter" data-dcat="material">
                <div className="d-sidebar-dot" style={{ background: '#fb923c' }}></div>
                <span className="d-sidebar-text">Material Handling</span>
              </button>
              <button className="d-sidebar-item d-cat-filter" data-dcat="inventory">
          ...
          <div className="d-main">
            ...
            {/* Pick & Place */}
            <div id="d-pick" style={{ marginBottom: '40px' }}>
              ...
              <div className="d-ds-grid">
                ...
                {/* Card 1 */}
                <div className="d-card" data-dcat="pick">
                  ...
                  <div className="d-photos">
                    ...
                    <div className="d-ph-thumbs">
                      <div className="d-ph-t"><img src="images/wh_pexels-tiger-lily-4483772.jpg" /></div>
                      <div className="d-ph-t"><img src="images/wh_pexels-ihsanaditya-10834810.jpg" /></div>
                      <div className="d-ph-t"><img src="images/wh_pexels-endura-tiles-370085044-14554082.jpg" /></div>
                    </div>
                  </div>
                ...
                <div className="d-card" data-dcat="pick">
                  ...
                  <div className="d-photos">
                    ...
                    <div className="d-ph-thumbs">
                      <div className="d-ph-t"><img src="images/wh_pexels-goldcircuits-8377802.jpg" /></div>
                      <div className="d-ph-t"><img src="images/wh_pexels-ihsanaditya-10834810.jpg" /></div>
                      <div className="d-ph-t"><img src="images/wh_pexels-tiger-lily-4483772.jpg" /></div>
                    </div>
                  </div>
            ...
            {/* Material Handling */}
            <div id="d-material" style={{ marginBottom: '40px' }}>
              <div className="d-sec-head">
                <div className="d-sec-dot"></div>
              ...
              <div className="d-ds-grid">
                ...
                {/* Card 4 */}
                <div className="d-card" data-dcat="material">
            ...
            {/* Inventory & QC */}
            <div id="d-inventory" style={{ marginBottom: '40px' }}>
              <div className="d-sec-head">
                <div className="d-sec-dot"></div>
              ...
              <div className="d-ds-grid">
                ...
                {/* Card 7 */}
                <div className="d-card" data-dcat="inventory">
...
export default RoboDataHubWarehouse;
